(function () {
  ...
  if (leadForm) {
    ...
    leadForm.addEventListener('submit', async function (event) {
      ...
      if (!endpoint) {
        setStatus('Form routing is not connected yet. Please email support@proadmins.io, call (631) 877-1393, or message us on WhatsApp for now.', 'error');
        return;
      }
      ...
      try {
        ...
        setStatus('Something went wrong. Please try again, email support@proadmins.io, or message us on WhatsApp.', 'error');
      } finally {
        if (submitButton) {
